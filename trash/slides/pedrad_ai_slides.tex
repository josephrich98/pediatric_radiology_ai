...
\begin{adjustbox}{max totalsize={\textwidth}{0.66\textheight}}
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{|>{\raggedright\arraybackslash}p{0.210\textwidth}|>{\raggedright\arraybackslash}p{0.165\textwidth}|>{\raggedright\arraybackslash}p{0.375\textwidth}|>{\raggedright\arraybackslash}p{0.345\textwidth}|>{\raggedright\arraybackslash}p{0.165\textwidth}|}
...
Gleamer & BoneView & X-ray fracture detection; international versions also flag dislocations, effusions and focal bone lesions & US fracture aid: ages 2--21 for specified extremity views; other anatomy adult-only (2023) & 4 (2022--2025) \\ \hline
AZmed & Rayvolve suite & MSK / chest finding detection; orthopedic measurements; GP bone age (separate modules) & US fracture indication age 2+ (2024); AZboneage is CE-marked; other eligibility varies by module & 4 (2022--2025) \\ \hline
...
16 Bit & Physis & Hand X-ray bone-age estimation, GP atlas matching and report assistance & Pediatric tool; no FDA authorization identified. Company's FDA entry is Rho (low bone density, age 50+) & 1 (2024) \\ \hline
Ever Fortune.AI & EFAI Bonesuite XR Bone Age Pro & GP bone-age quantification from PA left-hand / wrist radiographs & FDA-cleared 2024 for ages 2--16 (K234042) & 11 (2022--2026) \\ \hline
BrightHeart & Fetal EchoScan; View Classifier & EchoScan: flags 8 findings suspicious for fetal CHD; View Classifier: standard views / exam completeness & Prenatal: EchoScan, 2nd trimester; View Classifier, 2nd / 3rd; maternal age 18+ & 5 (2024--2025) \\ \hline
GE HealthCare / Canon / Siemens / Philips & TrueFidelity, AiCE, Deep Resolve, Precise Image & CT: TrueFidelity / AiCE / Precise Image (noise, dose); MRI: AiCE / Deep Resolve (noise, resolution, scan time) & Pediatric applications documented; age / anatomy / protocol depend on scanner and software version & 284 (2014--2026) \\ \hline
Subtle Medical / AIRS Medical & SubtleMR, SwiftMR & MRI image post-processing: denoising / sharpening to support shorter acquisitions or better image quality & No adult-only restriction in reviewed US indications; SwiftMR 2026 validation includes ages 0--21 & 13 (2018--2026) \\ \hline
Qure.ai & qXR / qER families & Chest X-ray detection / triage, TB screening, tube / heart measurements; head CT triage / quantification and CTA LVO & US eligibility varies by module; vendor reports CE-marked qXR TB use across ages 0--15 & 9 (2020--2026) \\ \hline
Aidoc / Viz.ai & BriefCase, Viz LVO / ICH & Aidoc: CT / CTA triage (e.g., ICH, LVO, PE, pneumothorax, fractures, free gas); Viz: LVO / ICH alerts, care coordination & Age / anatomy eligibility is module-specific; company totals do not establish pediatric indications & 43 (2018--2026) \\ \hline
\end{tabular}
\end{adjustbox}
\\[4pt]
{\scriptsize Counts = company-wide radiology entries in the FDA AI-enabled device list (saved 2026-09-03); grouped vendors are summed. Includes versions and unrelated products, not pediatric-clearance counts; parentheses = decision-year range. The list is not exhaustive and may lag new authorizations.\\[2pt]Functions / labeling checked 2026-09-16; features vary by market and version. GP = Greulich--Pyle; TW3 = Tanner--Whitehouse 3; CHD = congenital heart disease.}
\end{frame}
...
\scriptsize
\begin{itemize}
\item \textbf{Deep Learning: A Primer for Radiologists}

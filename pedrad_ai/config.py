...
# Selected products, checked against vendor / regulator sources 2026-09-16.
# See reports/commercial_software_verification.md for sources and scope.
# FDA counts cover company-wide radiology-list entries, including versions;
# they are neither counts of these products nor counts of pediatric indications.
COMMERCIAL_PEDIATRIC: list[dict[str, str]] = [
    {"vendor": "Gleamer", "product": "BoneView",
     "task": "X-ray fracture detection; international versions also flag dislocations, effusions and focal bone lesions",
     "pediatric": "US fracture aid: ages 2--21 for specified extremity views; other anatomy adult-only (2023)", "modality": "x-ray",
     "fda_company": "Gleamer", "url": "https://www.gleamer.ai/us/copilot/boneview"},
    {"vendor": "AZmed", "product": "Rayvolve suite",
     "task": "MSK / chest finding detection; orthopedic measurements; GP bone age (separate modules)",
     "pediatric": "US fracture indication age 2+ (2024); AZboneage is CE-marked; other eligibility varies by module", "modality": "x-ray",
    ...
    {"vendor": "16 Bit", "product": "Physis",
     ...
     "pediatric": "Pediatric tool; no FDA authorization identified. Company's FDA entry is Rho (low bone density, age 50+)", "modality": "x-ray",
     "fda_company": "16 Bit", "url": "https://www.16bit.ai/physis"},
    {"vendor": "Ever Fortune.AI", "product": "EFAI Bonesuite XR Bone Age Pro",
     "task": "GP bone-age quantification from PA left-hand / wrist radiographs",
     "pediatric": "FDA-cleared 2024 for ages 2--16 (K234042)", "modality": "x-ray",
     "fda_company": "Ever Fortune", "url": "https://www.accessdata.fda.gov/cdrh_docs/pdf23/K234042.pdf"},
    {"vendor": "BrightHeart", "product": "Fetal EchoScan; View Classifier",
    ...
    {"vendor": "Qure.ai", "product": "qXR / qER families",
     "task": "Chest X-ray detection / triage, TB screening, tube / heart measurements; head CT triage / quantification and CTA LVO",
     "pediatric": "US eligibility varies by module; vendor reports CE-marked qXR TB use across ages 0--15", "modality": "x-ray / CT",

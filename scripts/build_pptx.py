...
``slides/pedrad_ai_slides.tex`` is the hand-owned deck (edited directly, no
longer regenerated by ``build_slides.py``); this script reads that file and
re-creates each frame as a native PowerPoint slide:
